...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT meal FROM Meal meal WHERE meal.user.id=:userId AND meal.dateTime " +
                "BETWEEN :startDate AND :endDate ORDER BY meal.dateTime DESC"),
})
